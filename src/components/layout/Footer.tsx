export const Footer = () => {
  return (
    <footer className="w-full max-w-3xl mx-auto mt-auto py-8 mb-4 px-6 lg:px-8 relative flex flex-col items-center">
      <div className="flex justify-center items-center gap-8 text-neutral-500">
        <a
          href="https://github.com/quangminhhh"
          target="_blank"
        ...
        <a
          href="https://www.instagram.com/quang._.minhhh?igsh=ODF4M3RiZ2xtYWoy&utm_source=qr"
          target="_blank"
          rel="noopener noreferrer"
        ...
        <a
          href="https://www.facebook.com/quang.mihhh/"
          target="_blank"
          rel="noopener noreferrer"
      ...
      <div className="mt-4 text-[13px] sm:text-sm italic text-neutral-500/80 hover:text-cyan-400 transition-all duration-500 hover:scale-105 drop-shadow-sm hover:drop-shadow-[0_0_12px_rgba(34,211,238,0.8)] cursor-default select-none animate-pulse hover:animate-none">
        &quot;Inspired by Theo&quot;
      </div>
    </footer>
  );
